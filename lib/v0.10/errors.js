...
module.exports = {
  ...
  EISDIR: function (data) {
    if (typeof data === 'string') {
      return createError('EISDIR, ' + data, {
  ...
  args: {
    fd: function () {
      return new TypeError('Bad argument');
    },
    path: function () {
      return new TypeError('Bad argument');
    },
    ...
    length: function () {
      return new Error('Length extends beyond buffer');
    },
    options: function () {
      return new TypeError('Bad arguments');
    }
  },
