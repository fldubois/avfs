...
function VirtualFS() {
  ...
  var base = assign({},
    ...
    require('../common/avfs/descriptors')(storage, constants, handles, errors),
    require('../common/avfs/directories')(storage, constants),
    require('../common/avfs/exists')(storage),
    require('../common/avfs/files')(storage, constants, handles, errors),
...
VirtualFS.prototype.appendFileSync = function (filename, data, options) {
  ...
  return utils.invoke(this.base.appendFile, [filename, data, options], {
    EISDIR: function () {
...
VirtualFS.prototype.chmodSync = function (filepath, mode) {
  ...
  return utils.invoke(this.base.chmod, [filepath, mode], {
    EPERM: function () {
...
VirtualFS.prototype.chownSync = function (filepath, uid, gid) {
  ...
  return utils.invoke(this.base.chown, [filepath, uid, gid], {
    EPERM: function () {
...
VirtualFS.prototype.mkdirSync = function (filepath, mode) {
  ...
  return utils.invoke(this.base.mkdir, [filepath, mode], {
    EEXIST: function () {
...
VirtualFS.prototype.openSync = function (filepath, flags, mode) {
  ...
  return utils.invoke(this.base.open, [filepath, flags, mode], {
    EACCES: function () {
...
VirtualFS.prototype.readdirSync = function (filepath) {
  ...
  return utils.invoke(this.base.readdir, [filepath], {
    ENOTDIR: function () {
...
VirtualFS.prototype.readFileSync = function (filename, options) {
  ...
  return utils.invoke(this.base.readFile, [filename, options], {
    EISDIR: function () {
...
VirtualFS.prototype.readlinkSync = function (linkpath) {
  ...
  return utils.invoke(this.base.readlink, [linkpath], {
    EINVAL: function () {
...
VirtualFS.prototype.renameSync = function (oldPath, newPath) {
  ...
  return utils.invoke(this.base.rename, [oldPath, newPath], {
    EACCES: function () {
...
VirtualFS.prototype.rmdirSync = function (filepath) {
  ...
  return utils.invoke(this.base.rmdir, [filepath], {
    ENOTDIR: function () {
...
VirtualFS.prototype.symlinkSync = function (srcpath, dstpath) {
  ...
  return utils.invoke(this.base.symlink, [srcpath, dstpath], {
    EEXIST: function () {
...
VirtualFS.prototype.truncateSync = function (filepath, length) {
  ...
  return utils.invoke(this.base.truncate, [filepath, length], {
    EISDIR: function () {
      return errors.EISDIR({syscall: 'open', path: filepath});
    }
  });
...
VirtualFS.prototype.unlinkSync = function (filepath) {
  ...
  return utils.invoke(this.base.unlink, [filepath], {
    EISDIR: function () {
...
VirtualFS.prototype.writeFileSync = function (filename, data, options) {
  ...
  return utils.invoke(this.base.writeFile, [filename, data, options], {
    EISDIR: function () {
      return errors.EISDIR({syscall: 'open', path: filename});
    }
  });
