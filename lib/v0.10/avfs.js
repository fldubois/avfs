...
function VirtualFS() {
  ...
  var base = assign({},
    ...
    require('../common/avfs/descriptors')(storage, errors, constants, handles),
    ...
    require('../common/avfs/read-write')(storage, errors, constants, handles),
...
VirtualFS.prototype.readSync = function (fd, buffer, offset, length, position) {
  ...
  return this.base.read(fd, buffer, offset, length, position);
};
...
VirtualFS.prototype.writeSync = function (fd, buffer, offset, length, position) {
  ...
  return this.base.write(fd, buffer, offset, length, position);
};
