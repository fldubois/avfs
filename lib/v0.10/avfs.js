...
function VirtualFS() {
  ...
  var base = assign({},
    require('../common/avfs/attributes')(storage, errors, constants),
    require('../common/avfs/descriptors')(storage, errors, constants),
    require('../common/avfs/directories')(storage, errors, constants),
    require('../common/avfs/exists')(storage, errors),
    require('../common/avfs/links')(storage, errors, constants),
    require('../common/avfs/permissions')(storage, errors),
    require('../common/avfs/watchers')(storage, errors)
  );
...
VirtualFS.prototype.chmodSync = function (filepath, mode) {
  ...
  return this.base.chmod(filepath, mode);
};
...
VirtualFS.prototype.chownSync = function (filepath, uid, gid) {
  ...
  return this.base.chown(filepath, uid, gid);
};
...
VirtualFS.prototype.fchmodSync = function (fd, mode) {
  ...
  return this.base.fchmod(fd, mode);
};
...
VirtualFS.prototype.fchownSync = function (fd, uid, gid) {
  ...
  return this.base.fchown(fd, uid, gid);
};
...
VirtualFS.prototype.ftruncateSync = function (fd, length) {
  ...
  return this.base.ftruncate(fd, length);
};
...
VirtualFS.prototype.futimesSync = function (fd, atime, mtime) {
  ...
  return this.base.futimes(fd, atime, mtime);
};
...
VirtualFS.prototype.lchmodSync = function (filepath, mode) {
  ...
  var file = this.storage.get('chmod', filepath, false);
...
VirtualFS.prototype.lchownSync = function (filepath, uid, gid) {
  ...
  var file   = this.storage.get('chown', filepath, false);
...
VirtualFS.prototype.linkSync = function (srcpath, dstpath) {
  ...
  return this.base.link(srcpath, dstpath);
};
...
VirtualFS.prototype.lstatSync = function (filepath) {
  ...
  var element = this.storage.get('lstat', filepath, false);
...
VirtualFS.prototype.mkdirSync = function (filepath, mode) {
  ...
  return this.base.mkdir(filepath, mode);
};
...
VirtualFS.prototype.openSync = function (filepath, flagsString, mode) {
  ...
  return this.base.open(filepath, fgs, mode);
};
...
VirtualFS.prototype.readdirSync = function (filepath) {
  ...
  return this.base.readdir(filepath);
};
...
VirtualFS.prototype.readFileSync = function (filename, options) {
  ...
  if (this.base.handles[fd].file.get('type') === constants.S_IFDIR) {
    throw errors.EISDIR({syscall: 'read'});
  }

  var content = this.base.handles[fd].file.get('content');
...
VirtualFS.prototype.readlinkSync = function (linkpath) {
  ...
  return this.base.readlink(linkpath);
};
...
VirtualFS.prototype.readSync = function (fd, buffer, offset, length, position) {
  ...
  if (!base.handles.hasOwnProperty(fd) || base.handles[fd].isClosed() || !(base.handles[fd].isReadable())) {
    throw errors.EBADF({syscall: 'read'});
  }

  var file    = base.handles[fd].file;
  ...
  var pos = (position !== null) ? position : base.handles[fd].read;
  ...
  if (position === null) {
    base.handles[fd].read += bytesRead;
  }
...
VirtualFS.prototype.realpathSync = function (filepath, cache) {
  ...
  while (index < elems.length) {
    ...
    var elem = this.storage.get('lstat', base, false);
...
VirtualFS.prototype.renameSync = function (oldPath, newPath) {
  ...
  var oldDirectory = this.storage.get({syscall: 'rename', path: oldPath}, oldPath, 1);
  var newDirectory = this.storage.get({syscall: 'rename', path: oldPath}, newPath, 1);

  if (!oldDirectory.isWritable() || !newDirectory.isWritable()) {
    throw errors.EACCES({syscall: 'rename', path: oldPath});
  }

  var file = this.storage.get('rename', oldPath);

  this.storage.set({syscall: 'rename', path: oldPath}, newPath, file);

  this.storage.unset({syscall: 'rename', path: oldPath}, oldPath);
};
...
VirtualFS.prototype.rmdirSync = function (filepath) {
  ...
  return this.base.rmdir(filepath);
};
...
VirtualFS.prototype.symlinkSync = function (srcpath, dstpath) {
  ...
  return this.base.symlink(srcpath, dstpath);
};
...
VirtualFS.prototype.utimesSync = function (filepath, atime, mtime) {
  ...
  return this.base.utimes(filepath, atime, mtime);
};
...
VirtualFS.prototype.writeSync = function (fd, buffer, offset, length, position) {
  ...
  if (!base.handles.hasOwnProperty(fd) || base.handles[fd].isClosed() || !base.handles[fd].isWritable()) {
  ...
  if (base.handles[fd].flags & constants.O_APPEND) {
    pos = content.length;
  } else if (position !== null) {
    pos = position;
  } else {
    pos = base.handles[fd].write;
  }
