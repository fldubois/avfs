...
function VirtualFS() {
  ...
  var base = assign({},
    ...
    require('../common/avfs/files')(storage, errors, constants, handles),
...
VirtualFS.prototype.appendFileSync = function (filename, data, options) {
  ...
  return this.base.appendFile(filename, data, options);
};
...
VirtualFS.prototype.openSync = function (filepath, flags, mode) {
  ...
  return this.base.open(filepath, flags, mode);
};
...
VirtualFS.prototype.readFileSync = function (filename, options) {
  ...
  return this.base.readFile(filename, options);
};
...
VirtualFS.prototype.truncateSync = function (filepath, length) {
  ...
  return this.base.truncate(filepath, length);
};
...
VirtualFS.prototype.writeFileSync = function (filename, data, options) {
  ...
  return this.base.writeFile(filename, data, options);
};
