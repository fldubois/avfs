...
module.exports = {
  ...
  args: {
    fd: function () {
      return new TypeError('fd must be a file descriptor');
    },
    path: function () {
      return new TypeError('path must be a string');
    },
    mode: function () {
      return new TypeError('mode must be an integer');
    },
    length: function () {
      return new RangeError('Length extends beyond buffer');
    },
    options: function (options) {
      var type = typeof options;

      return new TypeError('Expected options to be either an object or a string, but got ' + type + ' instead');
    }
  },
  ...
  write: {
    args: {
      fd: function () {
        return new TypeError('First argument must be file descriptor');
      }
    }
  }
};
